...
module.exports = class PlayCommand extends Command {
  constructor(client) {
    super(client, {
      ...
      args: [
        {
          key: 'query',
          prompt: 'Que Cancion Deseas Escuchar?',
          type: 'string',
  ...
  async run(message, { query }) {
    ...
    if (!voiceChannel)
      return message.say('Entra A Un Canal De Voz Y Vuelve A Intentarlo');
    // end initial check
    if (message.guild.triviaData.isTriviaRunning == true)
      return message.say('Vuelve A Intentarlo Cuando Acabe La Trivia');
    ...
    try {
      ...
      const embed = new MessageEmbed()
        .setColor('#e9f931')
        .setTitle('Elija Una Cancion Escribiendo Del 1 Al 5')
      ...
      try {
        ...
        return message.say('Por Favor Escribe Un Numero Del 1 Al 5 o Exit');
      }
      ...
      try {
        ...
        return message.say(
          'Un Error Ha Ocurrido Intentado Conseguir La ID Del Video De YouTube'
        );
      }
      const url = `https://www.youtube.com/watch?v=${video.raw.id}`;
      const title = video.title;
      ...
      return message.say('Hubo Un Error Buscando La Cancion Que Pediste');
    }
  }
        ...
        const dispatcher = connection
          ...
          .on('start', () => {
            ...
            const videoEmbed = new MessageEmbed()
              ...
              .setColor('#e9f931')
              .addField('Reproduciendo Ahora:', queue[0].title)
          ...
          .on('error', e => {
            message.say('No Se Pueden Reproducir La Canción');
            console.error(e);
